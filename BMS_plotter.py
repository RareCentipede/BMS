...
sns.lineplot(results, x='time', y='voltage', hue='cell number', ax=ax_volt)
ax_volt.set_title('Voltage')
ax_volt.set_ylabel('Voltage (V)')


# plot current
sns.lineplot(results, x='time', y='current', ax=ax_cur)
...
sns.lineplot(results, x='time', y='power', ax=ax_power)
...
if display_temp:
    sns.lineplot(results, x='time', y='temperature_1', ax=ax_temp, label="Pack 1")
    sns.lineplot(results, x='time', y='temperature_2', ax=ax_temp, label="Pack 2")
    ax_temp.set_title('Temperature')
    ax_temp.set_ylabel('Temperature (°C)')

# plot resistances
if display_res:
    sns.lineplot(results, x='time', y='resistance', hue='cell number', ax=ax_res, legend=True)
